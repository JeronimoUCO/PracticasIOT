...
const char *ssid = "IOTUCO";               // Enter your WiFi name
const char *password = "LifeIsIoT";        // Enter WiFi password// MQTT Broker
const char *mqtt_broker = "192.168.1.101"; // Enter your WiFi or Ethernet IP
